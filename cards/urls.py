...
urlpatterns = [
    ...
    # Curriculum paths
    path('curriculum/', curriculum_view, name='user_deck_list'),
    ...
    path('decks/<str:subject>/<int:id>/', CardDetailView.as_view(), name='card-detail'),
    ...
    path('deck/<int:deck_id>/study/', study_session, name='study_session'),
